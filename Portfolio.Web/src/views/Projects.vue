<template>
  <v-container>
    ...
    <v-row>
      <v-col>
        <v-text-field
          ...
          label="Search through the Projects"
          clearable
          autofocus
        />
      </v-col>
    ...
    <v-sheet
      width="100%"
      color="transparent"
      v-for="typeProjects in projectsByType"
      :key="typeProjects[0].projectType"
    >
...
export default class Projects extends Vue {
  ...
  get projectsByType(): ViewModels.ProjectsViewModel[][] {
    const typeProjects: ViewModels.ProjectsViewModel[][] = _.chain(
      ...
      .groupBy((t) => t.projectType ?? "No Type")
      .values()
      .value();
    return typeProjects;
  }
